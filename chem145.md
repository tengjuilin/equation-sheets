...
# CHEM 145 Honor General Chemistry I Equations
## Table of Contents
- [CHEM 145 Honor General Chemistry I Equations](#chem-145-honor-general-chemistry-i-equations)
  - [Table of Contents](#table-of-contents)
  - [Gas](#gas)
    - [Kinetic Theory of Gas](#kinetic-theory-of-gas)
    - [Molecular Collisions and Rate Processes](#molecular-collisions-and-rate-processes)
...
|Maxwell-Boltzmann speed distribution|$f(v) = 4\pi (\dfrac{m}{2\pi k_{B}T}) v^{2} \exp(\dfrac{-mv^{2}}{2k_{B}T})$|
...
|Enthalpy change of any ideal gas|$\Delta H = nc_{P}\Delta T \\ = \Delta U + \Delta(PV) \\ = nc_{V}\Delta T + nR\Delta T$|
...
|Efficiency of Carnot engines|$\epsilon = \dfrac{\text{work on surrounding}}{\text{heat into system}} \\ = \dfrac{T_{\mathrm{high}} - T_{\mathrm{low}}}{T_{\mathrm{high}}} = 1-\dfrac{T_{\mathrm{low}}}{T_{\mathrm{high}}}$|
